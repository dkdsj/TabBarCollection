...
- (void)layoutSubviews {
    ...
    switch (self.position) {
        ...
        case MCTabBarCenterButtonPositionBulge:
            ...
            break;
        case MCTabBarCenterButtonPositionTop:
    ...
    //zz add
    //只切上左 上右 2个角
//    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:_centerBtn.bounds byRoundingCorners:UIRectCornerTopLeft | UIRectCornerTopRight cornerRadii:CGSizeMake(26, 26)];
//    CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
//    maskLayer.frame = _centerBtn.bounds;
//    maskLayer.path = maskPath.CGPath;
//    _centerBtn.layer.mask = maskLayer;
}
...
- (void)setCenterSelectedImage:(UIImage *)centerSelectedImage {
    ...
    //zz add
    //https://www.jianshu.com/p/bf7115b18d4b
    //https://www.jianshu.com/p/4824ffaada89
    [_centerBtn setImage:centerSelectedImage forState:UIControlStateSelected];
    [_centerBtn setImage:centerSelectedImage forState:UIControlStateHighlighted];
    [_centerBtn setImage:centerSelectedImage forState:UIControlStateSelected|UIControlStateHighlighted];
